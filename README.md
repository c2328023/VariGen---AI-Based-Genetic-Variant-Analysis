...
Our model is trained on a balanced dataset containing variants strictly categorized into Pathogenic and Benign classes. The ground truth labels are derived from highly reliable databases such as ClinVar, ClinGen, and gnomAD.

The multi-dimensional feature set includes:
- Sequence and Change Data: Reference/alternative nucleotides and resulting amino acid changes.
- Local Sequence Context: Genomic and proteomic neighborhoods (5 elements before and after the variant point).
- Biochemical and Structural Effects: Changes in hydrophobicity, polarity, and potential 3D structure impacts.
...
## Developer
Efekan Erkafalı - Software Engineering Student
